<html>
<head>
<title>Display Customer Information and Delete and Confirmation</title>
</head>
<body>
    ...
    <tr>
        <th width="40"><div align="center">CustomerID</div></th>
    ...
    <tr>
        <td><div align="center"><?php echo $result["CustomerID"];?></a></div></td>
        ...
        onclick="javascript:return confirm('คุณต้องการลบข้อมูลใช่หรือไม่');">Delete</a></div></td>
    </tr>
    <?php
    }
    ?>
